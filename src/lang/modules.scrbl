...
@form["url" "url(<url>)"]{
@pyret-block[#:style "good-ex"]{import url("https://raw.githubusercontent.com/brownplt/pyret-lang/refs/heads/horizon/tests/io-tests/tests/library-code.arr") L}
...
during development. Instead, they are intended as easy-to-use import links for
...
@pyret-block[#:style "good-ex"]{import url("https://raw.githubusercontent.com/brownplt/pyret-lang/refs/heads/horizon/tests/io-tests/tests/", "library-code.arr") L}
Depending on the @tt{--url-file-mode} option, load the module from a file or
from a URL:
@itemlist[
...
@item{@tt{local-if-present}: If a file is present at the given @tt{<rel-path>},
the import acts just like a @tt{file} import with the given @tt{<rel-path>} as
...
@tt{remote-only}, which will always load the code from the remote published
URL.
